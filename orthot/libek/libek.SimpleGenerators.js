...
libek.primitive = {
  ...
  Grid:function(params={}) {
    ...
    this.setAxis = function(axis, do_updatecolors=true) {
      ...
      switch(axis) {
        case libek.AXIS.X:
          this.obj.setRotationFromAxisAngle(libek.direction.vector.NORTH, T/4)
        break
        case libek.AXIS.Y:
          //this.obj.rotation.set(0,0,0)
          this.obj.setRotationFromAxisAngle(libek.direction.vector.UP, 0)
        break
        case libek.AXIS.Z:
          //this.obj.rotation.set(-T/4,0,0)
          this.obj.setRotationFromAxisAngle(libek.direction.vector.EAST, -T/4)
        break
      }
      if (do_updatecolors) {
        this.updateColors()
