...
orthot.AnimateCreature = function(zone, cr, nmap, _orient, trackcam=false) {
  ...
  let mCTL = cr.animCTL = {
    ...
    hopoffLadder:function(forward, up) {
     ...
     // mainINST.ctl.ahead.copy(libek.direction.vector[forward])    
      //mainINST.ctl.behind.copy(libek.direction.vector[libek.direction.invert[forward]])
    ...
    exitLadder:function(force) {
      ...
      //mainINST.ctl.ahead.copy(libek.direction.vector[force.toFORWARD])    
      //mainINST.ctl.behind.copy(libek.direction.vector[libek.direction.invert[force.toFORWARD]])
